from dependencies.custom.python import model
from dependencies.custom.python.services import external
from dependencies.custom.python.services.cutoff_filter import filter_indexes_by_cutoff
from dependencies.custom.python.helper_classes.request_classes.searchRequest import SearchRequest
...
def search(input_request):
    ...
    """
    print("HELLO WORLD", input_request)
